; ModuleID = '/home/arun/TakeDownHSS/part4_instrumentation/DivZeroInstrument/test/calc.opt.ll'
...
entry:
  ...
  tail call void @__coverage__(i32 3, i32 8), !dbg !11
  call void @llvm.dbg.declare(metadata i8* %operator, metadata !12, metadata !DIExpression()), !dbg !11
  tail call void @__coverage__(i32 4, i32 7), !dbg !14
  call void @llvm.dbg.declare(metadata i32* %firstNumber, metadata !15, metadata !DIExpression()), !dbg !14
  tail call void @__coverage__(i32 4, i32 19), !dbg !16
  call void @llvm.dbg.declare(metadata i32* %secondNumber, metadata !17, metadata !DIExpression()), !dbg !16
  tail call void @__coverage__(i32 6, i32 3), !dbg !18
  br label %do.body, !dbg !18

do.body:                                          ; preds = %do.cond, %entry
  tail call void @__coverage__(i32 7, i32 5), !dbg !19
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str, i64 0, i64 0)), !dbg !19
  tail call void @__coverage__(i32 8, i32 5), !dbg !21
  %call1 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i8* %operator), !dbg !21
  tail call void @__coverage__(i32 9, i32 5), !dbg !22
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i64 0, i64 0)), !dbg !22
  tail call void @__coverage__(i32 10, i32 5), !dbg !23
  ...
  tail call void @__coverage__(i32 11, i32 13), !dbg !24
  %0 = load i8, i8* %operator, align 1, !dbg !24
  tail call void @__coverage__(i32 11, i32 13), !dbg !24
  %conv = sext i8 %0 to i32, !dbg !24
  tail call void @__coverage__(i32 11, i32 5), !dbg !25
...
do.end:                                           ; preds = %do.cond
  tail call void @__coverage__(i32 28, i32 3), !dbg !60
  ret i32 0, !dbg !60
}
...
!1 = !DIFile(filename: "calc.c", directory: "/home/arun/TakeDownHSS/part4_instrumentation/DivZeroInstrument/test")
!2 = !{}
...
!11 = !DILocation(line: 3, column: 8, scope: !7)
!12 = !DILocalVariable(name: "operator", scope: !7, file: !1, line: 3, type: !13)
!13 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!14 = !DILocation(line: 4, column: 7, scope: !7)
!15 = !DILocalVariable(name: "firstNumber", scope: !7, file: !1, line: 4, type: !10)
!16 = !DILocation(line: 4, column: 19, scope: !7)
!17 = !DILocalVariable(name: "secondNumber", scope: !7, file: !1, line: 4, type: !10)
