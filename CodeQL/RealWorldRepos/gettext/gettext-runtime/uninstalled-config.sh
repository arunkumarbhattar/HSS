...
# not found.
XGETTEXT='/home/linuxbrew/.linuxbrew/bin/xgettext'

# XGETTEXT_015 is a GNU xgettext version ≥ 0.15, if found in $PATH, or ':' if
# not found.
XGETTEXT_015='/home/linuxbrew/.linuxbrew/bin/xgettext'

# GMSGFMT is a GNU msgfmt, if found in $PATH, or ':' if not found.
GMSGFMT='/home/linuxbrew/.linuxbrew/bin/msgfmt'

# GMSGFMT_015 is a GNU msgfmt version ≥ 0.15, if found in $PATH, or ':' if
# not found.
GMSGFMT_015='/home/linuxbrew/.linuxbrew/bin/msgfmt'
